...
import blooddonor.mosulclass.imran.blooddonor.model.User;
...
//                    addNewUser.setAdmin(isAdmin);
                    ...
                    if (TextUtils.isEmpty(addNewUser.getName()) && TextUtils.isEmpty(addNewUser.getEmail())&& TextUtils.isEmpty(addNewUser.getPassword()) && TextUtils.isEmpty(addNewUser.getMobile())  ) {
                        ...
                        authUser.fetchSignInMethodsForEmail(addNewUser.getEmail()).addOnCompleteListener(new OnCompleteListener<SignInMethodQueryResult>() {
                            @Override
